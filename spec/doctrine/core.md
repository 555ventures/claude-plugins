...
what to build with and how it should look; `/spec:init` grounds the repo (config, rules, agents; it
...
(genesis position briefs, atlas direction rounds, sketch brainstorms). **Sonnet** orchestrates
