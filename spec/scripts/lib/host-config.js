...
// read — strict-flavored consumers (ci-gate-parity.js, a now-retired design-render gate script)
// structurally could not call `readConfig` and read the file privately instead, which is what recurred the
