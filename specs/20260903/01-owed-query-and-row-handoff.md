...
**Merge-back deviation (2026-09-03).** D15's target 7.69.0 was taken by specs/20260902/10 while
this spec built (the Gotchas' "literal number is a target, not a pin" case); resolved at merge
to 7.70.0 with both changelog entries kept in the last-three form.
