...
|------|--------|-------|---------|
| spec/scripts/design-atlas.js | MODIFY | scripts | D1: register-after-theme rule in `cmdCheck` (warn at sketch, violation when bound); usage header |
...
| tests/design-atlas.test.js | MODIFY | tests | AC-20260906-06-1, AC-20260906-06-2 |
...
design-atlas.js check [--matrix] [--states] <file|dir>…
  violation (bound) / ⚠️ (sketch): <file>: links the wireframe register (wire/) after THEME — skin it in the picked theme (design/tokens.css)
