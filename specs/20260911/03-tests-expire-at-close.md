...
| spec/scripts/test-expiry.js | CREATE | scripts | CLI per D3/D4; uses `lib/scan-test-calls.js`, `lib/invariants.js`, `lib/spec-sections.js` (`parseAcBullets`, `normalizeForPinCheck`, `AC_ID_RE_GLOBAL`), `lib/frontmatter.js`, `lib/host-config.js` |
