...
const KEPT_TEST_NAMES = [
  'AC-20260907-10-1: WHEN every declared journey carries walked and marks.approved is unset THE SYSTEM derives CLIENT (--state prints CLIENT; a legacy status.json stamped state:"SIGNOFF" with those marks derives CLIENT), and the string SIGNOFF does not occur anywhere in spec/scripts/mocks-driver.js',
