...
test('AC-20260813-01-7: MISCITED guard: a wrong line number alone never proves miscitation without a whole-file search', () => {
...
test('AC-20260813-01-7: MISCITED guard: nonexistence claims require proving the working tree is the actual review target', () => {
...
test('AC-20260813-01-7: MISCITED guard: quoted evidence that confirms the claim forbids ruling MISCITED', () => {
...
test('AC-20260813-01-1: SANCTIONED guard: evidence that denies or fails to quote a sanctioning row forbids returning SANCTIONED', () => {
...
test('AC-20260813-01-2: the workflow mechanically audits killed[] label-evidence consistency instead of trusting the structured result alone', () => {
